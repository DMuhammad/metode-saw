...
<html lang="en">
    ...
    <!--navbar-->
        ...
        <div class="card col-sm-4 mx-auto mt-5" style="margin-bottom: 110px;">
            ...
            <div class="card-body">
                <form action="../../insert/insertalternatif.php" method="POST" autocomplete="off">
                    <div class="form-group">
                        <input type="text" name="nama_alternatif" class="form-control" placeholder="Nama Alternatif" autofocus><br>
                    </div>
                    <br>
