                ...
                <ul class="nav nav-pills">
                        ...
                        if(isset($_SESSION['metode'])){
                            ...
                            <?php
                                ...
                                <li class="nav-item dropdown">
                                    <a class="btn btn-dark dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Menu</a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="tampilan/menu/menu-topsis-maxmin/result.php">Detail Nilai Maksimum dan Minimum</a></li>
                                        <li><a class="dropdown-item" href="tampilan/menu/menu-topsis-nilaiV/result.php">Detail Nilai Preferensi Alternatif</a></li>
                                        <li><a class="dropdown-item" href="tampilan/menu/menu-topsis-normalisasi/result.php">Detail Normalisasi</a></li>
                                        <li><a class="dropdown-item" href="tampilan/menu/menu-topsis-terbobot/result.php">Detail Normalisasi Terbobot</a></li>
                                    </ul>
                                </li>
                            <?php
                            }
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="index.php?metode=topsis">TOPSIS</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
